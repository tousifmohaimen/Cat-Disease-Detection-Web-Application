...
<div class="card shadow  ml-3 mb-12">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Expert Data Table</h6>
    </div>
    <div class="card-body">
        <form method="post" encytpe="multipart/form-data">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                    <a class="badge badge-pill badge-primary" href="changeExpert.php?id_user=<?php echo $data["id_user"]; ?>">edit</a> |
                    <a href="function.php?act=hapusPakar&id_user=<?= $data["id_user"]; ?>" onclick="return confirm('Are you sure you want to delete data?');" class="badge badge-pill badge-danger">Delete</a>
                    </td>
                    <td><?= $data['nama']; ?></td>
                    <td><?= $data['email']; ?></td>
                    <td><?= $data['alamat']; ?></td>
            ...
            <?php if($_SESSION['role'] == 0) {
            echo'<a href="expertRegister.php" class="btn btn-primary my-2 px-2">Add Expert Data</a>';
            }?>
            </table>
        </form>
    </div>
