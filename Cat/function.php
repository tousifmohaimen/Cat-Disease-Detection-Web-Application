<?php
$koneksi = mysqli_connect('localhost', 'root', '', 'disease_detectdb_cat');
...
function registerPakar()
{
    ...
    if (!$exe) {
        ...
        // echo "<script type='text/javascript'> success(); </script>";
        echo "<script>
        alert('Successful Expert Registration!');
        document.location.href = 'expertIndex.php';
            </script>";
    }
}
...
function login() {
    ...
    if($data) {
        ...
        if(password_verify($input_pass, $password)) {
            ...
            echo "<script>
                alert('Username or password is empty/incorrect!');
                document.location.href = 'index.php';
                </script>";
    }
}
...
function tambahGejala()
{
    ...
    if (!$exe) {
        ...
        document.location.href = 'SymptomIndex.php'</script>";
}
...
function tambahPenyakit()
{
    ...
    if (!$exe) {
        die('Error pada database');
            ...
            echo "<script>
            alert('Disease successfully added');
            document.location.href = 'diseaseIndex.php'</script>";
}
...
function tambahSolusi()
{
    ...
    if (!$exe) {
        die('Errors in the database');
            ...
            document.location.href = 'solutionIndex.php'</script>";
}
...
function ubahGejala($id_gejala)
{
    ...
    if (!$exe) {
        ...
        echo "<script>
        alert('Symptom data successfully converted');
        document.location.href = 'SymptomIndex.php'</script>";
}
...
function ubahSolusi($id_solusi)
{
    ...
    if (!$exe) {
        die('Errors in the database');
            ...
            echo "<script>
            alert('Solution data successfully converted!');
            document.location.href = 'solutionIndex.php'</script>";
}
...
function ubahPenyakit($id_penyakit)
{
    ...
    if (!$exe) {
        die('Errors in the database');
            ...
            echo "<script>
            alert('Disease Data changed successfully!');
            document.location.href = 'diseaseIndex.php'</script>";
}
...
function ubahPasien($id_user)
{
    ...
    if (!$exe) {
        die('Errors in the database');
            ...
            echo "<script>
            alert('Patient Data successfully changed!');
...
function ubahPakar($id_user)
{
    ...
    if (!$exe) {
        die('Errors in the database');
            ...
            document.location.href = 'expertIndex.php'</script>";
}
...
function hapusGejala($id_gejala)
{
    ...
    if ($result > 0) {
        echo "
        <script>
                alert('Symptom removed successfully!');
                document.location.href = 'SymptomIndex.php';
            </script>	
        ";
    } else {
        echo "
        <script>
                alert('Symptoms failed to remove, because they are still tied to the disease!');
                document.location.href = 'SymptomIndex.php';
            </script>	
        ";
    }
...
function hapusPasien($id_user)
{
    ...
    if ($result > 0) {
        ...
        echo "
        <script>
                    alert('Patient Account failed to delete!');
                    document.location.href = 'indexAdmin.php';
            </script>	
        ";
    }
...
function hapusPakar($id_user)
{
    ...
    if ($result > 0) {
        ...
        echo "
        <script>
                    alert('Expert account failed to delete!');
                    document.location.href = 'expertIndex.php';
            </script>	
        ";
    }
...
function hapusPenyakit($id_penyakit)
{
    ...
    if ($result > 0) {
        echo "
        <script>
                alert('Disease successfully removed!');
                document.location.href = 'diseaseIndex.php';
            </script>	
        ";
    } else {
        echo "
        <script>
                    alert('The disease failed to be removed, because it is still tied to the symptoms!');
                    document.location.href = 'diseaseIndex.php';
            </script>	
        ";
    }
...
function hapusSolusi($id_solusi)
{
    ...
    if ($result > 0) {
        echo "
        <script>
                alert('Solution successfully removed!');
                document.location.href = 'solutionIndex.php';
            </script>	
        ";
    } else {
        echo "
        <script>
                    alert('Solution failed to delete!');
                    document.location.href = 'solutionIndex.php';
            </script>	
        ";
    }
