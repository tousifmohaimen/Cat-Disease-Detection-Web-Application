...
<body >
    ...
    <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between ml-4 py-5">
            <h1 class="h3 mb-0 text-gray-800 " id="tess">Add Solution Form</h1>
        </div>
    ...
    <form action="function.php?act=tambahSolusi" id="tambah" method="POST" >
        <div class="form-group">
            <label for="namaSolusi">Solution</label>
            <input type="text" class="form-control" id="namaSolusi" name="namaSolusi"  placeholder="Enter Solution">
        </div>
        <div class="form-group">
            <label for="id_penyakit" class="form-label">Disease Name</label>
            <select name="id_penyakit" id="id_penyakit" class="form-control">
                <option value="">Choose a Disease from Solutions</option>
