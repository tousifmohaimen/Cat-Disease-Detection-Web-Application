...
<body >
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Symptoms Data</div>
    ...
    <div class="card shadow mb-12">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Disease Data Table</h6>
        </div>
        <div class="card-body">
            <form method="post" encytpe="multipart/form-data">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                        <a class="badge badge-pill badge-primary" href="changeDisease.php?id_penyakit=<?php echo $data["id_penyakit"]; ?>">edit</a> |
                        <a href="function.php?act=hapusPenyakit&id_penyakit=<?= $data['id_penyakit']; ?>" onclick="return confirm('Are you sure you want to delete data?');" class="badge badge-pill badge-danger">Delete</a>
                        </td>
                ...
                <!-- <a href="tambahPenyakit.php" class="btn btn-primary my-2 px-2">Add Disease Data</a> -->
                </table>
            </form>
        </div>
    </div>
