...
<body >
    ...
    <div class="card shadow mb-12">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Symptom Data Table</h6>
        </div>
        <div class="card-body">
            <form method="post" encytpe="multipart/form-data">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                        <a class="badge badge-pill badge-primary" href="changeSymptom.php?id_gejala=<?php echo $data["id_gejala"]; ?>">edit</a> |
                        <a href="function.php?act=hapusGejala&id_gejala=<?= $data['id_gejala']; ?>" onclick="return confirm('Are you sure you want to delete data?');" class="badge badge-pill badge-danger">Delete</a>
                        </td>
                ...
                <a href="addedSymptom.php" class="btn btn-primary my-2 px-2">Add Symptom Data</a>
                </table>
            </form>
        </div>
    </div>
