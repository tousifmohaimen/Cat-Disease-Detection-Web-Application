...
<div class="card shadow  ml-3 mb-12">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Patient Data Table</h6>
    </div>
    <div class="card-body">
        <form method="post" encytpe="multipart/form-data">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                    <a class="badge badge-pill badge-primary" href="changePatient.php?id_user=<?php echo $data["id_user"]; ?>">edit</a> |
                    <a href="function.php?act=hapusPasien&id_user=<?= $data["id_user"]; ?>" onclick="return confirm('Are you sure you want to delete data?');" class="badge badge-pill badge-danger">delete</a>
                    </td>
                    <td><?= $data['nama']; ?></td>
                    <td><?= $data['email']; ?></td>
                    <td><?= $data['alamat']; ?></td>
