...
<body >
    ...
    <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between ml-4 py-5">
            <h1 class="h3 mb-0 text-gray-800 " id="tess">Form Add Disease</h1>
        </div>
    ...
    <form action="function.php?act=tambahPenyakit" id="tambah" method="POST" >
        <div class="form-group">
            <label for="namaGejala">Disease</label>
            <input type="text" class="form-control" id="namaPenyakit" name="namaPenyakit"  placeholder="Enter disease">
        </div>
        <!-- <div class="form-group">
